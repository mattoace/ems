...
function printTeachersPdf(ed){
    var selRow = table.row('.selected').data(); 
    var arrSpl = selRow['DT_RowId'].split('_'); 
    $("#reportView").html('<object data="/back/Jasper/zoneteachers.php?id='+arrSpl[1]+'&zone='+zone+' " type="application/pdf" width="1000px" height="700px">alt : Schools in my Zone</object>');
    $('#reportView').popup('show'); 
}
