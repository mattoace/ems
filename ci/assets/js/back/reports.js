...
loadUrlMarks = "/back/Marks.php?inst="+institutionDropdown.val()+"&class_id="+classDropdown.val()+"&stream_id="+streamDropdown.val()+"&exam_id="+examDropdown.val()+"&subject_id="+subjectDropdown+"&term_id="+termDropdown;
...
function chooseClasses(selVal){
 ...
 function chooseStream(selVal){
    ...
    var streamDropdown = $('#selector3');
     ...
     loadUrlMarks = "/back/Marks.php?case=1&inst="+institutionDropdown.val()+"&class_id="+classDropdown.val()+"&stream_id="+streamDropdown.val()+"&exam_id="+examDropdown.val()+"&subject_id="+subjectDropdown.val()+"&term_id="+termDropdown;
     tablesMarks.ajax.url(loadUrlMarks).load(); 
    
    }

  function streamChanged(){
     loadUrlMarks = "/back/Marks.php?case=2&inst="+institutionDropdown.val()+"&class_id="+classDropdown.val()+"&stream_id="+streamDropdown.val()+"&exam_id="+examDropdown.val()+"&subject_id="+subjectDropdown.val()+"&term_id="+termDropdown;
     tablesMarks.ajax.url(loadUrlMarks).load();     
  } 

  function subjectChanged(){
     loadUrlMarks = "/back/Marks.php?case=3&inst="+institutionDropdown.val()+"&class_id="+classDropdown.val()+"&stream_id="+streamDropdown.val()+"&exam_id="+examDropdown.val()+"&subject_id="+subjectDropdown.val()+"&term_id="+termDropdown;
     tablesMarks.ajax.url(loadUrlMarks).load(); 
  } 
  ...
  postVars = {
	...
	tablesMarks = $('#Marks').DataTable({
     ...
     editorMarks.on('preSubmit', function (obj,values,action) { //postSubmit
         ...
         $.post("../application/controllers/back/SaveMarks.php",postVars,function(data){ 
         
            //cell.data(values.data[row].e1.marks).draw();            
            loadUrlMarks = "../application/controllers/back/Marks.php?case=1&inst="+institutionDropdown.val()+"&class_id="+classDropdown.val()+"&stream_id="+streamDropdown.val()+"&exam_id="+examDropdown.val()+"&subject_id="+subjectDropdown.val()+"&term_id="+termDropdown.val();
