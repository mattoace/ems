...
<html lang="en">
  <head>
    ...
    <div style=' clear: both; text-align:center; position: relative;'>
        <a href="<?php echo base_url("http://windows.microsoft.com/en-US/internet-explorer/..");?>">
              ...
              <ul class="nav navbar-nav sf-menu" data-type="navbar">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <a href="<?php echo base_url("index.php/admin");?>">Education Management System</a>
                    </li>
                   <!-- <li>
      ...
      <section class="well well4">
        ...
        <div class="container center991">
          ...
          <div class="row offs3">
            <div class="col-md-4 col-sm-12 col-xs-12">
              <div class="thumbnail thumb-shadow">
                <img src="<?php echo base_url("assets/images/page-4_img1.jpg");?>" alt="">
          ...
          <div class="row">
            <div class="col-md-4 col-sm-12 col-xs-12">
              <div class="thumbnail thumb-shadow">
                <img src="<?php echo base_url("assets/images/page-4_img3.jpg");?>" alt="">
                <div class="caption bg3 capt_hover1">
                  <h3>
                    Elementum 
                  </h3>
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
              <div class="thumbnail thumb-shadow">
                <img src="<?php echo base_url("assets/images/page-4_img4.jpg");?>" alt="">
                <div class="caption bg3 capt_hover1">
                  <h3>
                    altum 
                  </h3>
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
              <div class="thumbnail thumb-shadow">
                <img src="<?php echo base_url("assets/images/page-4_img5.jpg");?>" alt="">
                <div class="caption bg3 capt_hover1">
                  <h3>
                    Adipiscing
                  </h3>
          ...
          <div class="row">
            <div class="col-md-4 col-sm-12 col-xs-12">
              <div class="thumbnail thumb-shadow">
                <img src="<?php echo base_url("assets/images/page-4_img6.jpg");?>" alt="">
                <div class="caption bg3 capt_hover1">
                  <h3>
                    Sit amet
                  </h3>
            ...
            <div class="col-md-8 col-sm-12 col-xs-12">
              <div class="thumbnail thumb-shadow">
                <img src="<?php echo base_url("assets/images/page-4_img7.jpg");?>" alt="">
                <div class="caption bg3 capt_hover1">
                  <h3>
                    sectetuer 
                  </h3>
