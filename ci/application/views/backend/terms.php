<title>EMS :: School Terms</title>
               <script>
                   $('#Examinations').css('background-color',activeMenu);
                   $('#13').css('background-color',activeMenu);  
               </script>
	<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">School Terms</h3>				
                  ...
                  <!--jquery ui editor-->
                                                ...
                                                <script type="text/javascript" src="<?php echo base_url("assets/js/back/terms.js");?>"></script> 
