<title>EMS :: Exam types</title>
                  <script>
                   $('#Examinations').css('background-color',activeMenu);
                   $('#10').css('background-color',activeMenu);  
               </script>
	<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">Examination Types</h3>				
                  ...
                  <!--jquery ui editor-->
                                                ...
                                                <script type="text/javascript" src="<?php echo base_url("assets/js/back/examtypes.js");?>"></script> 
