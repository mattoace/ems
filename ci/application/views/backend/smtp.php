<title>EMS :: Smtp settings</title>
                <script>
                   $('#Settings').css('background-color',activeMenu);
                   $('#22').css('background-color',activeMenu);  
               </script>
	<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">System Smtp Settings</h3>				
					  <div class="grid_3 grid_5">						
						 <div class="but_list">
						   <div class="well">
                                                       
                                                                <section>
                                                                        <table id="mySmtpTable" class="display" cellspacing="0" width="100%">
                                                                                <thead>
                                                                                        <tr>                                                                                          
                                                                                                <th></th>
                                                                                                <th>Smtp host</th>
...
<!--jquery ui editor-->
      <!--  <link rel="stylesheet" type="text/css" href="<?php echo base_url("assets/DataTables-1.10.11/media/css/dataTables.min.css");?>"> jquery.-->
        ...
        <script type="text/javascript" src="<?php echo base_url("assets/js/back/smtp.js");?>"></script> 
