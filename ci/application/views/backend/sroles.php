<title>EMS :: Users</title>
                <script>
                   ...
                   $('#5').css('background-color',activeMenu);  
               </script>
	<div id="page-wrapper">
				<div class="graphs">
    ...
    margin-bottom: 4px !important;
            ">Speacial System Priviledges</h3>				
                  ...
                  <!--jquery ui editor-->
                                              <!--  <link rel="stylesheet" type="text/css" href="<?php echo base_url("assets/DataTables-1.10.11/media/css/dataTables.min.css");?>"> jquery.-->
                                                ...
                                                <style type="text/css" class="init"></style>
                                                 ...
                                                 <script type="text/javascript" language="javascript" src="<?php echo base_url("assets/CryptoJS v3.1.2/rollups/md5.js");?>"></script>
                                                ...
                                                <script type="text/javascript" src="<?php echo base_url("assets/js/back/sroles.js");?>"></script> 
